...
func (p *GitHubProvider) IsEnabled() bool {
	return platformconfig.GitHubOAuthEnabled
}
...
func (p *GitHubProvider) ExchangeToken(ctx context.Context, code string, c *gin.Context) (*OAuthToken, error) {
	...
	values := map[string]string{
		"client_id":     platformconfig.GitHubClientId,
		"client_secret": platformconfig.GitHubClientSecret,
		"code":          code,
	}
...
func (p *GitHubProvider) FillUserByProviderID(user *identityschema.User, providerUserID string) error {
...
func (p *GitHubProvider) SetProviderUserID(user *identityschema.User, providerUserID string) {
