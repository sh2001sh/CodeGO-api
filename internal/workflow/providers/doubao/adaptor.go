...
func (a *TaskAdaptor) ConvertToOpenAIVideo(originTask *workflowschema.Task) ([]byte, error) {
	...
	if err := platformencoding.Unmarshal(originTask.Data, &dResp); err != nil {
	...
	if dResp.Status == "failed" {
		openAIVideo.Error = &dto.OpenAIVideoError{Message: dResp.Error.Message, Code: dResp.Error.Code}
	}
