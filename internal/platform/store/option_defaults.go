...
func buildDefaultOptionMap() map[string]string {
	optionMap := map[string]string{
		...
		"XunhuEnabled":                         strconv.FormatBool(commercestore.XunhuEnabled),
		"XunhuAppID":                           commercestore.XunhuAppID,
		"XunhuSecret":                          commercestore.XunhuSecret,
		"XunhuGateway":                         commercestore.XunhuGateway,
		"XunhuMinTopUp":                        strconv.Itoa(commercestore.XunhuMinTopUp),
		"WaffoEnabled":                         strconv.FormatBool(commercestore.WaffoEnabled),
		"WaffoApiKey":                          commercestore.WaffoApiKey,
		"WaffoPrivateKey":                      commercestore.WaffoPrivateKey,
		"WaffoPublicCert":                      commercestore.WaffoPublicCert,
		"WaffoSandboxPublicCert":               commercestore.WaffoSandboxPublicCert,
		"WaffoSandboxApiKey":                   commercestore.WaffoSandboxApiKey,
		"WaffoSandboxPrivateKey":               commercestore.WaffoSandboxPrivateKey,
		"WaffoSandbox":                         strconv.FormatBool(commercestore.WaffoSandbox),
		"WaffoMerchantId":                      commercestore.WaffoMerchantId,
		"WaffoNotifyUrl":                       commercestore.WaffoNotifyUrl,
		"WaffoReturnUrl":                       commercestore.WaffoReturnUrl,
		"WaffoSubscriptionReturnUrl":           commercestore.WaffoSubscriptionReturnUrl,
		"WaffoCurrency":                        commercestore.WaffoCurrency,
		"WaffoUnitPrice":                       strconv.FormatFloat(commercestore.WaffoUnitPrice, 'f', -1, 64),
		"WaffoMinTopUp":                        strconv.Itoa(commercestore.WaffoMinTopUp),
		"WaffoPayMethods":                      commercestore.WaffoPayMethods2JsonString(),
		"WaffoPancakeEnabled":                  strconv.FormatBool(commercestore.WaffoPancakeEnabled),
		"WaffoPancakeSandbox":                  strconv.FormatBool(commercestore.WaffoPancakeSandbox),
		"WaffoPancakeMerchantID":               commercestore.WaffoPancakeMerchantID,
		"WaffoPancakePrivateKey":               commercestore.WaffoPancakePrivateKey,
		"WaffoPancakeWebhookPublicKey":         commercestore.WaffoPancakeWebhookPublicKey,
		"WaffoPancakeWebhookTestKey":           commercestore.WaffoPancakeWebhookTestKey,
		"WaffoPancakeStoreID":                  commercestore.WaffoPancakeStoreID,
		"WaffoPancakeProductID":                commercestore.WaffoPancakeProductID,
		"WaffoPancakeReturnURL":                commercestore.WaffoPancakeReturnURL,
		"WaffoPancakeCurrency":                 commercestore.WaffoPancakeCurrency,
		"WaffoPancakeUnitPrice":                strconv.FormatFloat(commercestore.WaffoPancakeUnitPrice, 'f', -1, 64),
		"WaffoPancakeMinTopUp":                 strconv.Itoa(commercestore.WaffoPancakeMinTopUp),
		...
		"PayMethods":                           commercestore.PayMethods2JsonString(),
		"GitHubClientId":                       "",
		"GitHubClientSecret":                   "",
		"TelegramBotToken":                     "",
		"TelegramBotName":                      "",
		...
		"QuotaForInviter":                      strconv.Itoa(platformconfig.QuotaForInviter),
		"QuotaForInvitee":                      strconv.Itoa(platformconfig.QuotaForInvitee),
