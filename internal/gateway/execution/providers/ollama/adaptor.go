...
func (a *Adaptor) ConvertClaudeRequest(c *gin.Context, info *relaycommon.RelayInfo, request *dto.ClaudeRequest) (any, error) {
	...
	openaiRequest.(*dto.GeneralOpenAIRequest).StreamOptions = &dto.StreamOptions{IncludeUsage: true}
...
func (a *Adaptor) GetRequestURL(info *relaycommon.RelayInfo) (string, error) {
	...
	if strings.Contains(info.RequestURLPath, "/v1/completions") || info.RelayMode == gatewaycontract.RelayModeCompletions {
