...
var achievementCatalog = []achievementDefinition{
	...
	},
	{
		...
		Name:              "云团兔",
		Description:       "历史上达成连续签到 7 天，解锁稳定值守伙伴",
		Hint:              "连续签到一周即可解锁",
		Icon:              "calendar-range",
		Tier:              "epic",
		RewardUSD:         2.8,
		RewardTitle:       "连续签到补能",
		RewardDescription: "奖励 2.8 美元额度，作为连续活跃奖励",
	},
	{
		Key:               "month-streak",
		Name:              "像素龙",
		Description:       "历史上达成连续签到 30 天，解锁整套图鉴里的终阶主宠",
		Hint:              "坚持连续签到一个月即可点亮最终守护者",
		Icon:              "flame",
		Tier:              "legendary",
		RewardUSD:         6.6,
		RewardTitle:       "月度图鉴终奖",
		RewardDescription: "奖励 6.6 美元额度，作为长期留存与持续活跃的终阶奖励",
	},
}
...
var companionStages = []companionStage{
	...
	},
	{
		Name:            "契约龟",
		Title:           "宠物工位长",
		Flavor:          "伙伴们开始承担不同职责，签到、订阅、盲盒和分享都能转化成图鉴进度。",
		MinUnlocks:      6,
		NextUnlocksGoal: 10,
	},
	{
