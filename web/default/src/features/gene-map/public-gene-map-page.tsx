...
export function PublicGeneMapPage(props: { token: string }) {
  ...
  if (publicQuery.isLoading) {
    return (
      <div className='mx-auto max-w-6xl px-4 py-16'>
        <div className='rounded-[32px] border border-dashed border-border bg-card px-6 py-24 text-center text-sm text-muted-foreground'>
          正在加载基因图谱...
        </div>
      </div>
    )
  ...
  return (
    <div className='mx-auto max-w-7xl px-4 py-10'>
      <div className='rounded-[32px] border border-border bg-card p-5 shadow-[0_30px_100px_rgba(15,23,42,0.10)] dark:bg-card'>
