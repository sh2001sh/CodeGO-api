...
export function PublicGeneMapPage(props: { token: string }) {
  ...
  if (publicQuery.isLoading) {
    return (
      <div className='mx-auto max-w-6xl px-4 py-16'>
        <div className='rounded-[32px] border border-dashed border-slate-300 px-6 py-24 text-center text-sm text-slate-500 dark:border-slate-700 dark:text-slate-400'>
          正在加载基因图谱...
        </div>
      </div>
    )
  ...
  return (
    <div className='mx-auto max-w-7xl px-4 py-10'>
      <div className='rounded-[32px] border border-slate-200 bg-[radial-gradient(circle_at_top_right,rgba(14,165,233,0.18),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(16,185,129,0.16),transparent_30%),linear-gradient(145deg,rgba(255,255,255,0.98),rgba(248,250,252,0.98),rgba(240,253,250,0.98))] p-5 shadow-[0_30px_100px_rgba(15,23,42,0.10)] dark:border-slate-800 dark:bg-[radial-gradient(circle_at_top_right,rgba(14,165,233,0.18),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(16,185,129,0.16),transparent_30%),linear-gradient(145deg,rgba(2,6,23,0.96),rgba(15,23,42,0.96),rgba(17,24,39,0.94))]'>
        ...
        {comparison ? (
          <div className='mt-6 space-y-4'>
            ...
            <div className='rounded-[28px] border border-slate-200 bg-white/80 p-4 dark:border-slate-800 dark:bg-slate-950/55'>
          ...
          <div className='mt-6 space-y-4'>
            ...
            <div className='rounded-[28px] border border-slate-200 bg-white/82 p-5 dark:border-slate-800 dark:bg-slate-950/55'>
