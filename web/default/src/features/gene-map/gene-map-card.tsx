...
function Metric(props: { label: string; value: string }) {
  return (
    <div className='rounded-2xl border border-border bg-card/80 px-3 py-2.5 backdrop-blur'>
...
export function GeneMapCard(props: {
  ...
  return (
    <div
      className={cn(
        'relative overflow-hidden rounded-[28px] border border-border bg-card p-4 shadow-[0_28px_90px_rgba(15,23,42,0.10)] dark:bg-card',
        props.className
      )}
    >
      ...
      <div className='relative space-y-4'>
        <div className='flex flex-wrap items-start justify-between gap-3'>
          <div className='space-y-2'>
            <div className='flex items-center gap-2'>
              <div className='flex size-10 items-center justify-center rounded-2xl bg-foreground text-background shadow-sm dark:bg-emerald-400 dark:text-slate-950'>
        ...
        <div className='grid gap-4 xl:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]'>
          <div className='rounded-[24px] border border-border bg-card/80 p-4 backdrop-blur'>
            ...
            <div className='mt-4 flex h-5 overflow-hidden rounded-full bg-muted'>
              {topModels.length > 0 ? (
