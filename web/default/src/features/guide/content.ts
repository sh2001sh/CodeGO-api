...
export const guideSections: GuideSection[] = [
  ...
  },
  {
    ...
    title: '宠物图鉴与增益',
    summary:
      '成就页里的每一只宠物都不再只是装饰。解锁后可以装备、升级，并把增益真实作用到任务、签到或盲盒链路。',
    steps: [
    ...
    notes: [
      ...
      '图鉴卡片会同时展示宠物等级、经验、下次升级消耗和当前增益效果。',
      '升级门槛与消耗按 1 到 5 级递增：40 / 130 / 310 / 630 经验，对应 0.5 / 1.2 / 3 / 6.5 美元额度。',
      '当前已经接入的宠物增益包含四类：每日任务额外奖励、签到补给、盲盒保底推进、宠物升级折扣。',
    ],
    images: [
      {
  ...
  },
  {
    ...
    notes: [
      ...
      '若当前出战的是盲盒系宠物，它会减少触发保底前所需的连续低奖励次数。',
    ],
  },
  {
    id: 'wallet',
