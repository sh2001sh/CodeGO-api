...
export const STATIC_I18N_KEYS = [
  ...
  'Use the desktop app to write Codex, Claude Code, or Gemini CLI settings with backup and recovery support.',
  ...
  'Current admin',
  'Awaiting publisher reply',
  'Reply received',
  'Awaiting executor confirmation',
  'Reply to material request',
  'Effect image URL {{number}}',
  'Review note',
  'Ledger reservation',
  'Copy reservation ID',
  'Submission failed. Check the GitHub links and try again.',
  'Publishing failed. No quota was frozen.',
  'Deadline must be later than now',
  'Title must be at least 4 characters',
  'Title must be at most 80 characters',
  'Add the task background and goal',
  'Description must be at most 20000 characters',
  'Enter a GitHub repository, Issue, or project URL',
  'Use an https://github.com/ URL',
  'Reward must be a positive integer',
  'Select a delivery deadline',
  'Application not selected',
  'Material request timed out',
  'Material timeout handled',
  'Review started',
  ...
  'Copy Commit SHA',
  'Open GitHub Issue',
  'Effect images from Commit {{commit}}',
  'Effect image unavailable',
  'Effect image unavailable. Ask the publisher to grant GitHub access or provide a public link.',
  'GitHub reference URL (optional)',
  'Material timeout action saved',
  'No reply after 48 hours',
  'Extend 48 hours',
  'Cancel without fault',
  'Confirm review decision',
  'Acceptance settles the frozen reward immediately.',
  ...
  'Confirm',
  'Unable to load admin bounty data. Refresh and try again.',
  'Unable to load quota balances. Refresh and try again.',
  'No bounty tasks in the queue.',
  'Suspend this bounty task?',
  ...
  'Report submitted',
  'Partial settlement amount (USD)',
  'Partial amount (USD)',
  'Reward must be at least $0.01',
  'Reward amount (USD)',
  ...
  'Bounty notification',
  'Open the task to review the latest update.',
  'Message: {{content}}',
  'The reward is frozen and the task is waiting for applications.',
  'The executor asked for additional material or a decision.',
  'Material request replied',
  'New application received',
  'Someone applied to take your task. Review their application.',
  'The publisher confirmed you as the executor. You can start development.',
  'The publisher selected another executor. Thank you for applying.',
  'The task has entered development.',
  'A material request now has a reply.',
  'The material request is resolved and the task can continue.',
  'No reply was received within 48 hours. Choose an available timeout action.',
  'Material reply window extended',
  'The material reply window was extended.',
  'New delivery received',
  'A GitHub delivery was submitted. Review it within 72 hours.',
  'The delivery needs more changes before settlement.',
  'The 72-hour review window will end soon.',
  'Task settled automatically',
  ...
  'The task was cancelled and the frozen reward was released.',
  'The deadline passed and the frozen reward was released.',
  'The task entered platform review and the reward remains frozen.',
  'An administrator recorded a final dispute resolution.',
  'An administrator paused the task and participant actions.',
  'An administrator resumed the task.',
  'Task reported',
  'A user reported this task. Review it in the admin area.',
  'Report resolved',
  'An administrator handled your task report.',
  'Chat Area',
