...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/xunhu/notify", controller.XunhuNotify)
			userRoute.GET("/xunhu/notify", controller.XunhuNotify)
			userRoute.GET("/xunhu/return", controller.XunhuReturn)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/image-workspace/items/:id/content", controller.GetImageWorkspaceItemContent)
				...
				selfRoute.GET("/aff/overview", controller.GetAffiliateRewardsOverview)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/user_subscriptions/:id/reset", controller.AdminResetUserSubscriptionQuota)
		...
		apiRouter.POST("/blind-box/epay/return", anonymousRequestBodyLimit, controller.BlindBoxEpayReturn)
		apiRouter.POST("/blind-box/xunhu/notify", anonymousRequestBodyLimit, controller.BlindBoxXunhuNotify)
