...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&BlindBoxCredit{}, "BlindBoxCredit"},
		{&BlindBoxOpenRecord{}, "BlindBoxOpenRecord"},
		{&BlindBoxProp{}, "BlindBoxProp"},
		{&BlindBoxPityState{}, "BlindBoxPityState"},
		{&BlindBoxPreConsumeRecord{}, "BlindBoxPreConsumeRecord"},
		{&AchievementUnlock{}, "AchievementUnlock"},
		{&UserCompanionPet{}, "UserCompanionPet"},
		{&DailyMissionReward{}, "DailyMissionReward"},
		{&GeneMapShare{}, "GeneMapShare"},
		{&UserWeChatBinding{}, "UserWeChatBinding"},
		{&MiniProgramBindCode{}, "MiniProgramBindCode"},
		...
		{&ReferralPurchaseReward{}, "ReferralPurchaseReward"},
		{&SubscriptionResetOpportunityAccount{}, "SubscriptionResetOpportunityAccount"},
		{&SubscriptionResetOpportunityLedger{}, "SubscriptionResetOpportunityLedger"},
...
` + "`group_buy_bonus_2`" + ` decimal(10,2) DEFAULT 0,
` + "`group_buy_bonus_3`" + ` decimal(10,2) DEFAULT 0,
` + "`group_buy_bonus_5`" + ` decimal(10,2) DEFAULT 0,
` + "`renewal_bonus_2`" + ` decimal(8,4) DEFAULT 0,
` + "`renewal_bonus_3`" + ` decimal(8,4) DEFAULT 0,
` + "`renewal_bonus_4`" + ` decimal(8,4) DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "group_buy_bonus_2", DDL: "`group_buy_bonus_2` decimal(10,2) DEFAULT 0"},
		{Name: "group_buy_bonus_3", DDL: "`group_buy_bonus_3` decimal(10,2) DEFAULT 0"},
		{Name: "group_buy_bonus_5", DDL: "`group_buy_bonus_5` decimal(10,2) DEFAULT 0"},
		{Name: "renewal_bonus_2", DDL: "`renewal_bonus_2` decimal(8,4) DEFAULT 0"},
		{Name: "renewal_bonus_3", DDL: "`renewal_bonus_3` decimal(8,4) DEFAULT 0"},
		{Name: "renewal_bonus_4", DDL: "`renewal_bonus_4` decimal(8,4) DEFAULT 0"},
