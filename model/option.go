...
func InitOptionMap() {
	...
	common.OptionMap["HomePagePackagesContent"] = ""
	...
	if raw, err := common.Marshal(DefaultPointMallRulesConfig()); err == nil {
		common.OptionMap[PointMallRulesOptionKey] = string(raw)
	}
