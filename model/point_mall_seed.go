...
func SeedDefaultPointMallProducts() error {
	...
	defaults := []PointMallProduct{
		{Name: "京东 E 卡 10 元", Type: PointProductTypeJDCard, PointsPrice: 20, FaceValue: 10, DailyLimitPerUser: 1, MonthlyLimitPerUser: 10, SortOrder: 80, Status: PointProductStatusOn, ImageUrl: "/assets/point-mall/jd-card-10.svg", Description: "兑换后可在兑换记录中查看卡密；10 元默认发放两张 5 元卡密。"},
		{Name: "京东 E 卡 20 元", Type: PointProductTypeJDCard, PointsPrice: 40, FaceValue: 20, DailyLimitPerUser: 1, MonthlyLimitPerUser: 5, SortOrder: 70, Status: PointProductStatusOn, ImageUrl: "/assets/point-mall/jd-card-20.svg", Description: "兑换后可在兑换记录中查看卡密。"},
		{Name: "盲盒券 *1", Type: PointProductTypeBlindBox, PointsPrice: 3, BlindBoxQuantity: 1, VirtualStock: 999999, MonthlyLimitPerUser: 20, SortOrder: 60, Status: PointProductStatusOn, ImageUrl: "/assets/point-mall/blind-box-1.svg", Description: "兑换后立即获得 1 次盲盒开启机会。"},
		{Name: "盲盒券 *5", Type: PointProductTypeBlindBox, PointsPrice: 12, BlindBoxQuantity: 5, VirtualStock: 999999, MonthlyLimitPerUser: 10, SortOrder: 50, Status: PointProductStatusOn, ImageUrl: "/assets/point-mall/blind-box-5.svg", Description: "兑换后立即获得 5 次盲盒开启机会。"},
